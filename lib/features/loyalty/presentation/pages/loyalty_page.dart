...
class LoyaltyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = context.read<LoyaltyCubit>();
    return SafeArea(
      bottom: false,
      child: BlocBuilder<LoyaltyCubit, LoyaltyState>(
        builder: (context, state) {
          final points = state.summary.pointsBalance;
          return QueryBody(
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        state.summary.tier.toUpperCase(),
                        style: GoogleFonts.dmSans(
                          color: Colors.white,
                          letterSpacing: 2,
                          fontSize: 12,
                ...
                Row(
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text('points_history'.tr),
                    ),
                  ],
                ),
                ...state.summary.recentActivity.map(
                  (entry) => ListTile(
                ...
                TextButton(
                  onPressed: controller.openRedeemed,
                  child: Text('redeemed_rewards'.tr),
                ),
              ],
            ),
          );
