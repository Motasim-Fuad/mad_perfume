    ...
    return ScreenScaffold(
      ...
      child: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          EarnStepRow(number: '01', title: 'step_browse'.tr, body: 'step_browse_copy'.tr),
          EarnStepRow(number: '02', title: 'step_collect'.tr, body: 'step_collect_copy'.tr),
          EarnStepRow(number: '03', title: 'step_redeem'.tr, body: 'step_redeem_copy'.tr),
        ],
      ),
    );
  }
